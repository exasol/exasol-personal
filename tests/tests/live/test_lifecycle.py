...
"""Lifecycle and provisioning tests."""
...
def test_stop_and_start(reusable_live_deployment: Deployment) -> None:
    ...
    info_result = reusable_live_deployment.info()
    ...
    # Stop the deployment
    stop_result = reusable_live_deployment.stop()
    ...
    start_result = reusable_live_deployment.start()
    ...
    if not sys.platform.startswith("win"):
        connect_result = reusable_live_deployment.connect()
...
def test_remote_archive_registered(
    ...
    host, port = shared_live_deployment.admin_ui()
    username, password = shared_live_deployment.admin_ui_credentials()
    deployment_id = shared_live_deployment.deployment_id()
