...
- [x] 3.2 Migrate legacy overlay-backed `/exa` data through sibling staging without overwriting populated storage or deleting the source prematurely
...
- [x] 4.2 Centralize platform runtime selection for all local workflows, promote Linux host Podman to `local`, remove `local-host`, and make VM sizing and shell behavior platform-specific
