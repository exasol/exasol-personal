...
Define the contract that CLI users and automation can rely on for how commands use standard output and standard error, when call-to-action guidance appears, and how expected failures are reported.
