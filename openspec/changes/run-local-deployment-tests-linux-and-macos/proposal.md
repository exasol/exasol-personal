...
- Keep the workflow manually dispatched and preserve platform-specific test skips and Python setup.
...
The deployment-test GitHub Actions workflow, its shared composite action inputs, Task descriptions, and CI/testing documentation are affected. Launcher runtime behavior, public CLI behavior, cloud credentials, and automatic pull-request CI are unchanged.
